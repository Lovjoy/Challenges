	...
	public static void main(String[] args) {
		...
		while (playerCurrentHp > 0) {
			...
			case 1:
				 ...
				 * player does (player stat * random number 0.75-1.25) and will always be the
				...
				if (exploreEnemy) {
					...
					// Monster stats are scaled with player stats with random coefficient
					// (0.75-1.25)
			...
			case 2:
				/*
				 * Go to Town Once a player is in town, they may do one of three things. - visit
				 * the temple (heals to full hp) - purchase a tome of strength (+1 strength for
				 * 100 gold) - purchase a tome of stamina (+1 stamins for 100 gold)
				 */
